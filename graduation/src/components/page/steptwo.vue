    ...
    <div class="hoteldetail-ct">
      <div class="right_top">
          <div class="right_top_content">
                <div class="chircle">
                    <div >
                        <span class="active"> <Icon type="checkmark-round "></Icon></span>
                          <!-- <span >1</span> -->
                    </div>
                    <b>注册</b>
                </div>
             ...
             <div class="line" :class="{active:stap == 3}"></div>
             <div class="chircle">
                 <div >
                       <span  :class="{active:stap == 3}">3</span>
                </div>
                 <b>确认</b>
             </div>
          </div>
      ...
      <div class="one">
            ...
            <div class="mail_box" style="    margin-left: 157px;">
                性别：
      <input type="radio" name="bm" value="1" style="margin-left: 10px;"/>男 <input name="bm" type="radio"  style="margin-left: 10px;" value="2"/>女

            </div>
            <div class="mail_box" style="    margin-left: 141px;">
                手机号：
